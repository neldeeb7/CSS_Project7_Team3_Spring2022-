...
medicaid_expansion %>%
  ...
  ylab('Uninsured Rate')
```
The parallel trends plot for the uninsured rate over time between California and Florida seems to meet the assumption that the trends between the two states
were relatively parallel prior to the treatment year, showing fairly similar slopes
...
syn = gsynth(uninsured_rate ~ year, medicaid_expansion, )
